...
#remember_species denotes whether reads are kept together with other reads from the same genome. default behavior is that this is false...
#reads from different genomes are mixed together


class genome_data(object):
	
	def __init__(self,input_filename,output_filename,read_length=100,genome_type='DNA',remember_species = False, shuffler = False):
